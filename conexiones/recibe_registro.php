...
/*try{*/
    ...
    //FALTA TERMINAR ESTA PESTAÑA DE RELLENO BASE DE DATOS!
    ...
    try {
        $comando  = $pdo ->query("INSERT INTO usuarios (nombre_completo, direccion, telefono,ID_tipo_usuario, codigo, usuario, contrasena, email, estado) VALUES ('$nombre','$direccion','$telefono','$ID_tipo_usuario','$codigo','$usuario','$contrasena','$email',1)");
