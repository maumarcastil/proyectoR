                                ...
                                <table class="table table-dark">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($lista as $x) {
                                            ...
                                            echo '<td>' . $x[6] . '</td>';
                                            echo '<td>' . $x[5] . '</td>';
                                            echo '<td><form action="../conexiones/eliminarUsuario.php" method="POST"><button type="submit" class="btn btn-primary p-1" name="usuario" value="'.$x[0].'">Aceptar</button></form></td>';
                                        }
                                        ?>
                                    </tbody>
                                </table>
